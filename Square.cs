...
{
    public class Square //// Для чего вообще нам нужен этот класс?
    {
        ...
        public Square(Vector2f position, int movementSpeed, IntRect movementBounds)   //// Что делает этот конструктор?
        {
        ...
        protected virtual void OnClick() { }  //// Не понятно, что мы делаем здесь?
